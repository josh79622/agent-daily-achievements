...
- Each chunk is summarized against only its own evidence manifest. A final
  merge request receives the chunk summaries and their source evidence, not
  the original full-day conversations.
...
complete day payload
  ...
  -> merge chunk summaries and evidence
